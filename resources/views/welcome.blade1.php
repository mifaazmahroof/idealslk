                        ...
                        <div class="item" style="background-image: url(public/frontend/assets/images/sliders/02.jpg);">
                            <div class="container-fluid">
                                <div class="caption bg-color vertical-center text-left">
                                    ...
                                    <div class="big-text fadeInDown-1"> Bike <span class="highlight">Craze</span> </div>
                ...
                <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
                    <div class="more-info-tab clearfix ">
                        ...
                        <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
                            ...
                            <li><a data-transition-type="backSlide" href="#smartphone" data-toggle="tab">CD125 Benly</a></li>
                            <li><a data-transition-type="backSlide" href="#laptop" data-toggle="tab">CD200</a></li>
                            <li><a data-transition-type="backSlide" href="#apple" data-toggle="tab">CM125 Twin</a></li>
                            <li><a data-transition-type="backSlide" href="#apple" data-toggle="tab">CD125 Twin</a></li>
                        </ul>
                        <!-- /.nav-tabs -->
                    </div>
